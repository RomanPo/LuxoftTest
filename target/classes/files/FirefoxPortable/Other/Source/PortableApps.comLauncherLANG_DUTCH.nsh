...
LangString LauncherAskCopyLocal ${LANG_DUTCH} "${PORTABLEAPPNAME} blijkt opgestart te zijn vanaf een locatie die alleen-lezen is. Wilt u een tijdelijke kopie naar uw hardeschijf kopi�ren en het programma daarvandaan opstarten?$\n$\nPrivacywaarschuwing: Als u Ja kiest, zullen uw persoonlijke gegevens van ${PORTABLEAPPNAME} tijdelijk gekopie�erd worden naar een lokale schijf. Hoewel deze gegevens na het afsluiten van ${PORTABLEAPPNAME} worden verwijderd, kan het mogelijk zijn dat iemand deze gegevens later kan benaderen."
